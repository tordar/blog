...
Add the following to the `"hooks"` section of `~/.claude/settings.json`. This must go in the global settings file (not a project-level one) so the hooks fire across all your codebases.
